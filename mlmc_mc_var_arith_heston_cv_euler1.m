function price1 = mlmc_mc_var_arith_heston_cv_euler1 (r, sigma, K, S0, T,h,  M, N, dW)
...
for l=0:L
        ...
        b_l = b_l(1,2) / var(payoffs_MC);
         ...
         if l==0
             ...
             payoffs_var(l+1)=log(var(payoffs_arith)); %Var MLMC
          ...
          n=M0*M^(l-1);
            ...
            for t=1:M0*M^(l-1)
                ...
                payoffs_var(l+1)=log(var(payoffs_arith-payoffs_c_arith)); %Var MLMC
